            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="row">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
					  <a href="products.php" class="nav-link active">LIST</a>
					</li>
					<li class="nav-item">
					  <a href="archived.php" class="nav-link " >ARCHIVED</a>
					</li>
				 </ul>
				...
				<?php while($val = $customer->fetch_object()){ ?>
				  <tr>
                    ...
                    <td class="text-center"><a href="feedback.php?id=<?php echo $val->item_id;?>"><?php echo $val->item_name;?></a></td>
					  ...
					  <div class="modal-content">
						...
						<div class="modal-body">
						   ...
						   <div class="row">
							...
							<div class="col-12" id="item-category">
							  <label for="inputNanme4" class="form-label">Archive: </label>
